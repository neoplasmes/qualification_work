...
const EffectEditor = ({
    ...
    const kindLabel = effect.kind === 'insertRow' ? 'Insert row' : 'Update by match';
    const datasetName = datasets.find(d => d.dataset.id === effect.datasetId)?.dataset.name;
        ...
        <div className={`${styles['card']} ${styles['effect-card']}`}>
            <div className={styles['card-header']}>
                <div data-stack="v" data-gap="xs">
                    ...
                    <h4 className={styles['section-title']}>{kindLabel}</h4>
                                    ...
                                    <div className={styles['value-header']}>
                                        ...
                                        <div className={styles['source-toggle']}>
                                            <button
                                                type="button"
                                                disabled={disabled}
                                                className={`${styles['source-btn']} ${mapping.sourceKind === 'parameter' ? styles['active'] : ''}`}
                                                onClick={() =>
                                                    onUpdateMapping(effect.id, mapping.id, { sourceKind: 'parameter' })
                                                }
                                            >
                                                param
                                            </button>
                                            <button
                                                type="button"
                                                disabled={disabled}
                                                className={`${styles['source-btn']} ${mapping.sourceKind === 'literal' ? styles['active'] : ''}`}
                                                onClick={() =>
                                                    onUpdateMapping(effect.id, mapping.id, { sourceKind: 'literal' })
                                                }
                                            >
                                                literal
                                            </button>
