...
import type { MultipartFile, MultipartParserService } from '@/core/ports/services';

/**
 * multipart/form-data parser over @fastify/busboy - the fork of original busboy, which is deprecated
 *
 * @export
 * @class FastifyBusboyMultipartParserService
 * @implements {MultipartParserService}
 */
export class FastifyBusboyMultipartParserService implements MultipartParserService {
    async parse(
