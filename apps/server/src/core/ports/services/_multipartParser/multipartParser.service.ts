...
/**
 * multipart/form-data stream parser. Used only locally in the implementation layer.
 * thus, it can use raw request and request headers
 *
 * @export
 * @interface MultipartParserService
 */
export interface MultipartParserService {
    /**
